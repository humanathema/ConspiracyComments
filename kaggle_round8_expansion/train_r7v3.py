"""Train two-stage ModernBERT ensemble — TAG=r7v3
...
DATA_FILE = "/kaggle/input/stance-r8-training-splits/stance_classifier_training_data_round7_bigval_split_v3.parquet"
OUT = "/kaggle/working"
TAG = "r7v3"
