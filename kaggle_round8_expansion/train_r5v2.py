"""Train two-stage ModernBERT ensemble — TAG=r5v2
...
DATA_FILE = "/kaggle/input/stance-r8-training-splits/stance_classifier_training_data_round5_bigval_split_v2.parquet"
OUT = "/kaggle/working"
TAG = "r5v2"
